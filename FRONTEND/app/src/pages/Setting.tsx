...
const projects = [
  { id: 1, name: 'Learning Goal', status: 'Software Engineer', progress: 100, due: 'Set', color: 'bg-violet-500' },
  { id: 2, name: 'Preferred Language', status: 'English', progress: 100, due: 'Set', color: 'bg-pink-500' },
  { id: 3, name: 'Notification Preferences', status: 'Daily nudges enabled', progress: 100, due: 'Set', color: 'bg-emerald-500' },
  { id: 4, name: 'VoiceBridge Settings', status: 'Phone reminders off', progress: 0, due: 'Not set', color: 'bg-blue-500' },
];
    ...
    <div className="p-4 lg:p-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500">Personalize how COGNOS adapts to you</p>
        </div>
